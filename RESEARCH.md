...
- BSD is not part of that deferred second stage. HDB states that stamp duty and legal fees are paid when signing the Agreement for Lease; IRAS requires stamp duty within 14 days of the contract or agreement. The BTO table therefore includes BSD in the first-stage amount.
